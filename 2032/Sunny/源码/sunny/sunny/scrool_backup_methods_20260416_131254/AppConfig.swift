...
/// 域名
fileprivate let app_lowerData:String = "corawde"
fileprivate let user_imageRemotePath:String = "gaboylx"
public let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "raw", with: "") + user_imageRemotePath.replacingOccurrences(of: "boy", with: ""))
/// 包ID
let PackageID = "2032"
/// Adjust
let AdjustKey = "ktbq9ek0grnk"
let AdInstallToken = "od968x"
