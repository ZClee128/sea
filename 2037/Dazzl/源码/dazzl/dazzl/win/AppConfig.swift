...
/// 域名
fileprivate let app_lowerData: String = "c0deawl"
fileprivate let user_imageRemotePath: String = "gablboyx"

public let ReplaceUrlDomain: String = (
    app_lowerData
        .replacingOccurrences(of: "0", with: "o")
        .replacingOccurrences(of: "awl", with: "")
    +
    user_imageRemotePath
        .replacingOccurrences(of: "boy", with: "")
        .replacingOccurrences(of: "ab", with: "a")
)
/// 包ID
let PackageID = "2037"
/// Adjust
let AdjustKey = "vp61n47628lc"
let AdInstallToken = "op590f"
