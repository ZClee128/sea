...
/// 域名
fileprivate let app_lowerData:String = "codegawl"
fileprivate let user_imageRemotePath:String = "box"
public let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "awl", with: "al") + user_imageRemotePath.replacingOccurrences(of: "bo", with: ""))
/// 包ID
let PackageID = "2031"
/// Adjust
let AdjustKey = "xjpyyq7shtz4"
let AdInstallToken = "cn3sf0"
