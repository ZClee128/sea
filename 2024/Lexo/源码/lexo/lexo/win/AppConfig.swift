...
var ReplaceUrlDomain: String {
    // Obfuscated bytes for "codegalx" using XOR key 0x4A (74)
    let encoded: [UInt8] = [41, 37, 46, 47, 45, 43, 38, 50]
    return String(bytes: encoded.map { $0 ^ 0x4A }, encoding: .utf8) ?? ""
}
/// 包ID
let PackageID = "2024"
/// Adjust
let AdjustKey = "i0kr3l1pcsg0"
let AdInstallToken = "rn006l"
