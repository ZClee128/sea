...
final class AppWebViewJavascriptBridge {
    ...
    func callHandler(_ handlerName: String, data: Any? = nil, responseCallback: AppWebViewBridgeResponseCallback? = nil) {
        ...
        if let responseCallback {
            let callbackId = "objc_cb_\(m830_830())"
    ...
    func handleNavigationAction(_ navigationAction: WKNavigationAction,
        ...
        guard sanitizeCommand906(url) else {
            return false
        }
    ...
    private func dispatchMessage(_ message: [String: Any]) {
        guard let messageJSON = iaebxiue36(from: message) else { return }
        let escapedMessageJSON = ieered8(messageJSON)
    ...
    private func iaebxiue36(from value: Any) -> String? {
    ...
    private func ieered8(_ value: String) -> String {
        value
    ...
    private func m830_830() -> Int {
        uniqueId += 1
        return uniqueId
    }

    private func sanitizeCommand906(_ url: URL) -> Bool {
