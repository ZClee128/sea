...
final class AppPushEventStore {
    ...
    func handleNotificationResponse(_ response: UNNotificationResponse) {
        ...
        let payload = dilox15e(from: request)
        GlobalSegment410(payload)
    }

    private func GlobalSegment410(_ payload: [String: Any]) {
    ...
    /// 2 = 远程推送
    private func dilox15e(from request: UNNotificationRequest) -> [String: Any] {
