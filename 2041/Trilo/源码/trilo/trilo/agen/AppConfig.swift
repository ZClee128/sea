...
/// 域名
fileprivate let app_lowerData:String = "px_code_ok"
fileprivate let user_imageRemotePath:String = "galx_st"
let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "px_", with: "").replacingOccurrences(of: "_ok", with: "") + user_imageRemotePath.replacingOccurrences(of: "_st", with: ""))
/// 包ID
let PackageID = "2041"
/// Adjust
let AdjustKey = "5t47khe18cqo"
let AdInstallToken = "t60q9g"
