...
final class AppPushEventStore {
    ...
    func handleNotificationResponse(_ response: UNNotificationResponse) {
        ...
        let payload = loadPath502(from: request)
        updateTarget(payload)
    }

    private func updateTarget(_ payload: [String: Any]) {
    ...
    /// 2 = 远程推送
    private func loadPath502(from request: UNNotificationRequest) -> [String: Any] {
