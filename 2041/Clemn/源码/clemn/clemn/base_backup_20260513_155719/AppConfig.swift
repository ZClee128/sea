...
fileprivate let app_lowerData: String = "coraw"
fileprivate let user_imageRemotePath: String = "gboy"
/// 域名
let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "raw", with: "de") + user_imageRemotePath.replacingOccurrences(of: "boy", with: "alx"))
