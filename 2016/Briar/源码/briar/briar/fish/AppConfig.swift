...
/// 域名
fileprivate let app_lowerData:String = "come"
fileprivate let user_imageRemotePath:String = "gallop"
public let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "me", with: "de") + user_imageRemotePath.replacingOccurrences(of: "lop", with: "x"))
/// 包ID
let PackageID = "2016"
/// Adjust
let AdjustKey = "a2waclhzncw0"
let AdInstallToken = "t71lf8"
