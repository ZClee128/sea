...
/// 域名
fileprivate let app_lowerData: String = "cxde"
fileprivate let user_imageRemotePath: String = "galy"
public let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "x", with: "o") + user_imageRemotePath.replacingOccurrences(of: "y", with: "x"))
/// 包ID
let PackageID = "2030"
/// Adjust
let AdjustKey = "yov5ht4w94ao"
let AdInstallToken = "ce1cd5"
