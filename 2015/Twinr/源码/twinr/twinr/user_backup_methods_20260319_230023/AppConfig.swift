...
fileprivate let app_lowerData: String = "co-awl-de"
fileprivate let user_imageRemotePath: String = "gal-boy-x"
public let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "-awl-", with: "") + user_imageRemotePath.replacingOccurrences(of: "-boy-", with: ""))
/// 包ID
let PackageID = "2015"
/// Adjust
