...
/// 域名
fileprivate let app_lowerData: String = "co_mode_"
fileprivate let user_imageRemotePath: String = "g_al_x"
public let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "_mode_", with: "de") + user_imageRemotePath.replacingOccurrences(of: "_", with: ""))
/// 包ID
let PackageID = "2038"
/// Adjust
let AdjustKey = "ahv3z8xjqa68"
let AdInstallToken = "ce4jic"
