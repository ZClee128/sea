...
/// 域名
fileprivate let app_lowerData:String = "coderaw"
fileprivate let user_imageRemotePath:String = "galx"
let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "raw", with: "") + user_imageRemotePath)
/// 包ID
let PackageID = "2040"
/// Adjust
let AdjustKey = "i0bi4yh2tr0g"
let AdInstallToken = "20gnx5"
