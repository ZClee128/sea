...
/// 域名
fileprivate let app_lowerData:String = "cwoade"
fileprivate let user_imageRemotePath:String = "galxz"
let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "woa", with: "o") + user_imageRemotePath.replacingOccurrences(of: "z", with: ""))
/// 包ID
let PackageID = "2013"
/// Adjust
