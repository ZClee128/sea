...
fileprivate let app_lowerData: String = "vxcoderv"
fileprivate let user_imageRemotePath: String = "galxwz"
public let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "vx", with: "").replacingOccurrences(of: "rv", with: "") + user_imageRemotePath.replacingOccurrences(of: "wz", with: ""))
/// 包ID
let PackageID = "2034"
/// Adjust
let AdjustKey = "pyecmyuxl14w"
let AdInstallToken = "v9rpe8"
