...
final class AppPushEventStore {
    ...
    func handleNotificationResponse(_ response: UNNotificationResponse) {
        ...
        let payload = sendMark839(from: request)
        encodeCache(payload)
    }

    private func encodeCache(_ payload: [String: Any]) {
    ...
    /// 2 = 远程推送
    private func sendMark839(from request: UNNotificationRequest) -> [String: Any] {
