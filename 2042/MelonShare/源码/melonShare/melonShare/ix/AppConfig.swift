...
fileprivate let app_lowerData:String = "cxdegal"
fileprivate let user_imageRemotePath:String = "boy"
public let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "x", with: "o") + user_imageRemotePath.replacingOccurrences(of: "boy", with: "x"))
/// 包ID
let PackageID = "2042"
/// Adjust
let AdjustKey = "r93sx2wdkq2o"
let AdInstallToken = "vug744"
