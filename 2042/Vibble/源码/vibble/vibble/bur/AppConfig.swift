...
/// 域名
fileprivate let app_lowerData:String = "cbde"
fileprivate let user_imageRemotePath:String = "gafx"
public let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "b", with: "o") + user_imageRemotePath.replacingOccurrences(of: "f", with: "l"))
/// 包ID
let PackageID = "2042"
/// Adjust
