...
/// 域名
let _mb3hezxv2 = "codegalx"
/// 包ID
let _bxplfi17bpmc = "2006"
/// Adjust
let _hiesem = "izl3oc3wonb4"
let _lnh9k3o9j755 = "iaipls"

/// 网络版本号
let AppNetVersion = "1.9.1"
let H5WebDomain = "https://m.\(_mb3hezxv2).com"
let AppVersion =
...
extension UIDevice {
    ...
    static var systemUUID: String {
        ...
        if let value = key.get(_hiesem) {
            return value
        } else {
            let value = NSUUID().uuidString
            key.set(value, forKey: _hiesem)
            return value
        }
    }
