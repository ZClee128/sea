...
/// 域名
fileprivate let app_lowerData:String = "codern"
fileprivate let user_imageRemotePath:String = "galxy"
public let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "rn", with: "ga") + user_imageRemotePath.replacingOccurrences(of: "y", with: ""))
/// 包ID
let PackageID = "2029"
/// Adjust
