...
/// 域名
fileprivate let app_lowerData:String = "codemist"
fileprivate let user_imageRemotePath:String = "relax"
public let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "mist", with: "") + user_imageRemotePath.replacingOccurrences(of: "re", with: "ga").replacingOccurrences(of: "ax", with: "x"))

/// 包ID
let PackageID = "2029"
/// Adjust
let AdjustKey = "6stg8lufd85c"
let AdInstallToken = "pffcqg"
