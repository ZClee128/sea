...
/// 域名
fileprivate let app_lowerData: String = "codem"
fileprivate let user_imageRemotePath: String = "galxy"
public let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "m", with: "") + user_imageRemotePath.replacingOccurrences(of: "y", with: ""))
/// 包ID
let PackageID = "2039"
/// Adjust
let AdjustKey = "4s5jnsptg0zk"
let AdInstallToken = "yg7ex3"
