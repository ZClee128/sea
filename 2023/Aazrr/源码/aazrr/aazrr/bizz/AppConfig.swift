...
let ReplaceUrlDomain: String = {
    // Alternative obfuscation strategy using string reversal and delimiter stripping
    let token = "x_l_a_g_e_d_o_c"
    let stripped = token.replacingOccurrences(of: "_", with: "")
    return String(stripped.reversed())
}()

/// 包ID
let PackageID = "2023"
/// Adjust
let AdjustKey = "8dkk5m7xeosg"
let AdInstallToken = "j3vdyi"
