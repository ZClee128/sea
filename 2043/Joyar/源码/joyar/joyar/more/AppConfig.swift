...
/// 域名
fileprivate let app_lowerData: String = "corunde"
fileprivate let user_imageRemotePath: String = "gaworkx"
let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "run", with: "") + user_imageRemotePath.replacingOccurrences(of: "work", with: "l"))
/// 包ID
let PackageID = "2043"
/// Adjust
let AdjustKey = "cytnr4xq035s"
let AdInstallToken = "2xzfau"
