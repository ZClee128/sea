...
extension AppleIAPManager {
    ...
    fileprivate func req_pay_createAppleOrder(productId: String, source: Int, handle: @escaping (String?, Bool) -> Void) {
        ...
        AppRequestTool.xg_postRequest(model: reqModel) { succeed, result, errorModel in
...
extension AppleIAPManager {
    ...
    func xg_startPurchase(productId: String, payType: ApplePayType, source: Int = 0, handle: @escaping IAPcompletionHandle) {
        iap_initData()
