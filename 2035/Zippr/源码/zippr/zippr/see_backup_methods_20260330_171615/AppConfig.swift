...
/// 域名
fileprivate let app_lowerData: String = "coabc"
fileprivate let user_imageRemotePath: String = "xyzgalx"
public let ReplaceUrlDomain = (app_lowerData.replacingOccurrences(of: "abc", with: "de") + user_imageRemotePath.replacingOccurrences(of: "xyz", with: ""))
/// 包ID
let PackageID = "2035"
/// Adjust
let AdjustKey = "f1hvdmz0vqbk"
let AdInstallToken = "ey1mqp"
